...
public class NewSaleController implements Initializable {
    ...
    public NewSaleController() {
        employeeBO = AppInitializer.ctx.getBean(EmployeeBO.class);
        stockBO = AppInitializer.ctx.getBean(StockBO.class);
        saleBO = AppInitializer.ctx.getBean(SaleBO.class);
        orderBO = AppInitializer.ctx.getBean(OrderBO.class);
    }
