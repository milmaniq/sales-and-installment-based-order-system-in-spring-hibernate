...
public class OrderBOImpl implements OrderBO {
    ...
    @Override
    public ArrayList<OrderDTO> getOrderByName(String name) throws Exception {
        try {
    ...
    @Override
    public ArrayList<OrderDTO> getOrderByContact(String contact) throws Exception {
        try {

            List<Order> orders = orderDAO.getOrderByContact(contact);
    ...
    @Override
    public ArrayList<OrderItemDTO> getOrderItemsByOrderId(String orderId) throws Exception {
        try {
...
//            for (OrderItemDTO orderItemDTO : orderItemDTOs) {
//
//               session.createNamedQuery("upadteOrderItem")
